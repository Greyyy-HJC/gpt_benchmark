...
# %%
if False:
    g.save("../conf/S8T8/wilson_b6.balance", U_it, g.format.nersc())
    U_check = g.load("../conf/S8T8/wilson_b6.balance")
...
# %%
#! save configs
U_it = g.load("../conf/S8T8/wilson_b6.balance")

for n_conf in range(3):
    for gap in range(40):
        it = n_conf * 40 + gap
    ...
    g.save(f"../conf/S8T8/wilson_b6.{n_conf}", U_it, g.format.nersc())
